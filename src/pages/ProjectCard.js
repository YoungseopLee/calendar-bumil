  ...
  return (
    <div className="project-card" onClick={handleCardClick}>
      ...
      <p className="project-code">
        <strong>프로젝트 코드:</strong> {project.code}
      </p>
      <p className="project-group">
        <strong>그룹명:</strong> {project.group}
      </p>
      <p className="project-owner">
        <strong>영업대표:</strong> {project.owner}
      </p>
      <p className="project-pm">
        <strong>PM:</strong> {project.pm}
      </p>
      <p className="project-period">
        <strong>기간:</strong> {formatDate(project.startDate)} ~{" "}
